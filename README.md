...
| --- | --- | --- |
| Controller | Implemented | `@smmr/core` deterministic workflow, budgets, loop detection, reflections, validated evidence, and atomic evidence-first completion enforcement |
