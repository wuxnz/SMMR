...
| --- | --- | --- |
| Controller | Implemented | `@smmr/core` deterministic workflow, budgets, loop detection, reflections, validated and snapshot-isolated evidence, and atomic evidence-first completion enforcement |
