export declare const SMMR_BOULDER_DIR: ".smmr"
export declare const LEGACY_BOULDER_DIR: ".omo"
export declare const BOULDER_DIR: ".omo"
export declare const BOULDER_FILE: "boulder.json"
export declare const BOULDER_STATE_PATH: ".smmr/boulder.json"
export declare const NOTEPAD_DIR: "notepads"
export declare const NOTEPAD_BASE_PATH: ".smmr/notepads"
export declare const PROMETHEUS_PLANS_DIR: ".smmr/plans"
